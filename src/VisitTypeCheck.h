...
namespace Stella
{
  ...
  private:
      ...
      Type *_match = nullptr; // To get Type from match expression

      RecordFieldType *_rec_type = nullptr; // To get Type from expression
      ListRecordFieldType *_record_type_list = nullptr; // To get ListRecordFieldType from expression

      VariantFieldType *_var_type = nullptr;
      OptionalTyping *_var_opt_type = nullptr;
      ListVariantFieldType *_var_type_list = nullptr;
  public:
