...
/********************   DeclFun    ********************/
    DeclFun::DeclFun(ListAnnotation *p1, StellaIdent p2, ListParamDecl *p3, ReturnType *p4, ThrowType *p5, ListDecl *p6,
                     Expr *p7) {
        listannotation_ = p1;
        stellaident_ = p2;
        listparamdecl_ = p3;
...
/********************   ListVariantFieldType    ********************/
    ...
    bool ListVariantFieldType::cmp(ListVariantFieldType *listType) {
        for (int i = 0; i < this->size(); i++) {
