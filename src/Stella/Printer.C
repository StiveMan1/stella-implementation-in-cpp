...
//You may wish to change render
    ...
    void PrintAbsyn::visitAProgram(AProgram *p) {
        ...
        _i_ = 0;
        p->languagedecl_->accept(this);
        _i_ = 0;
        visitListExtension(p->listextension_);
        _i_ = 0;
        visitListDecl(p->listdecl_);
    ...
    void PrintAbsyn::visitAnExtension(AnExtension *p) {
        ...
        render("with");
        _i_ = 0;
        visitListExtensionName(p->listextensionname_);
    ...
    void PrintAbsyn::visitDeclFun(DeclFun *p) {
        ...
        _i_ = 0;
        visitListAnnotation(p->listannotation_);
        render("fn");
        visitStellaIdent(p->stellaident_);
        render('(');
        _i_ = 0;
        visitListParamDecl(p->listparamdecl_);
        render(')');
        _i_ = 0;
        p->returntype_->accept(this);
        _i_ = 0;
        p->throwtype_->accept(this);
        render('{');
        _i_ = 0;
        visitListDecl(p->listdecl_);
        render("return");
    ...
    void PrintAbsyn::visitTypeRecord(TypeRecord *p) {
        ...
        render('{');
        _i_ = 0;
        visitListRecordFieldType(p->listrecordfieldtype_);
        render('}');
    ...
    void PrintAbsyn::visitTypeVariant(TypeVariant *p) {
        ...
        render("<|");
        _i_ = 0;
        visitListVariantFieldType(p->listvariantfieldtype_);
        render("|>");
    ...
    void PrintAbsyn::visitPatternTuple(PatternTuple *p) {
        ...
        render('{');
        _i_ = 0;
        visitListPattern(p->listpattern_);
        render('}');
    ...
    void PrintAbsyn::visitPatternRecord(PatternRecord *p) {
        ...
        render('{');
        _i_ = 0;
        visitListLabelledPattern(p->listlabelledpattern_);
        render('}');
    ...
    void
    PrintAbsyn::iterListLabelledPattern(ListLabelledPattern::const_iterator i, ListLabelledPattern::const_iterator j) {
        if (i == j) return;
        if (i == j - 1) { /* last */
            (*i)->accept(this);
        } else { /* cons */
    ...
    void PrintAbsyn::visitLet(Let *p) {
        ...
        render("let");
        _i_ = 0;
        visitListPatternBinding(p->listpatternbinding_);
        render("in");
        _i_ = 1;
        p->expr_->accept(this);
    ...
    void PrintAbsyn::visitMatch(Match *p) {
        ...
        render('{');
        _i_ = 0;
        visitListMatchCase(p->listmatchcase_);
        render('}');
    ...
    void PrintAbsyn::visitRecord(Record *p) {
        ...
        render('{');
        _i_ = 0;
        visitListBinding(p->listbinding_);
        render('}');
    ...
    void
    PrintAbsyn::iterListPatternBinding(ListPatternBinding::const_iterator i, ListPatternBinding::const_iterator j) {
        if (i == j) return;
        if (i == j - 1) { /* last */
            (*i)->accept(this);
        } else { /* cons */
    ...
    void PrintAbsyn::iterListVariantFieldType(ListVariantFieldType::const_iterator i,
                                              ListVariantFieldType::const_iterator j) {
        if (i == j) return;
        if (i == j - 1) { /* last */
            (*i)->accept(this);
        } else { /* cons */
            (*i)->accept(this);
            render(',');
            iterListVariantFieldType(i + 1, j);
        }
    }
    ...
    void
    PrintAbsyn::iterListRecordFieldType(ListRecordFieldType::const_iterator i, ListRecordFieldType::const_iterator j) {
        if (i == j) return;
        if (i == j - 1) { /* last */
            (*i)->accept(this);
        } else { /* cons */
    ...
    void ShowAbsyn::visitListLabelledPattern(ListLabelledPattern *listlabelledpattern) {
        for (ListLabelledPattern::const_iterator i = listlabelledpattern->begin();
             i != listlabelledpattern->end(); ++i) {
            (*i)->accept(this);
    ...
    void ShowAbsyn::visitListVariantFieldType(ListVariantFieldType *listvariantfieldtype) {
        for (ListVariantFieldType::const_iterator i = listvariantfieldtype->begin();
             i != listvariantfieldtype->end(); ++i) {
            (*i)->accept(this);
    ...
    void ShowAbsyn::visitListRecordFieldType(ListRecordFieldType *listrecordfieldtype) {
        for (ListRecordFieldType::const_iterator i = listrecordfieldtype->begin();
             i != listrecordfieldtype->end(); ++i) {
            (*i)->accept(this);
